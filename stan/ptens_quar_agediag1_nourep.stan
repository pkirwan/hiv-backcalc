...
parameters{
  ...
  vector[4*nagroup] alpha; // age group specific (ag) and state (k) specific linear time trend for dx probs --- 
}
...
transformed parameters{
  ...
  // Initializing delta
  delta1[1] = -3.2 + 0.2*delta_raw1[1]; // worth reconsidering? Originally for diag in 85
  delta2[1] = -3.2 + 0.2*delta_raw2[1]; // worth reconsidering? Originally for diag in 85
  delta3[1] = -3.0 + 0.2*delta_raw3[1]; // worth reconsidering? Originally for diag in 85
  delta4[1] = -2.5 + 0.3*delta_raw4[1]; // worth reconsidering? Originally for diag in 85
