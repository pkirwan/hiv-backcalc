...
model{
  ...
  // Infection
  // Need to give a reasonably strong prior to first infections
  // Infections mean 250, sd 100
  gamma[1] ~ normal(5.521461, 0.2938935); 
  ...
  tail(gamma, nquar - 1) ~ normal( head(gamma, nquar - 1), sqrt(var1));
